...
public class EasyExam extends Exam {

    public EasyExam(Lesson lesson, String examWatcher, String examName, String category, String examLocation) {
    ...
    public Exam makeExam(int classic, int multipleChoice, int truefalse) {
        ...
        EasyExam easyExam = new EasyExam(getLesson(),getExamWatcher(),getExamName(),getCategory(),getExamLocation());
        easyExam.setQuestions(exam_questions);
        return easyExam;
    }
}
