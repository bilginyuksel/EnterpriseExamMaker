...
public class NormalExam extends Exam {

    public NormalExam(Lesson lesson, String examWatcher, String examName, String category, String examLocation) {
    ...
    public Exam makeExam(int classic, int multipleChoice, int truefalse) {
        ...
        NormalExam normalExam = new NormalExam(getLesson(),getExamWatcher(),getExamName(),getCategory(),getExamLocation());
        normalExam.setQuestions(exam_questions);
        return normalExam;
    }
}
